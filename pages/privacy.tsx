  ...
  return (
    <Container className="w-full md:w-4/5 mt-20">
      <Card className="p-4 my-8 md:m-6">
        <IconButton className="mr-auto" onClick={pushRoute('/')} aria-label="Retour à la page d'accueil" size="large">
          <ArrowBack />
        </IconButton>
        ...
        <div className="mt-8 text-justify">
          ...
          <p>
            Vos renseignements sont &eacute;galement collect&eacute;s par le biais de l&apos;interactivit&eacute;
            pouvant s&apos;&eacute;tablir entre vous et notre site Web et ce, de la fa&ccedil;on suivante:
          </p>
          <ul className="p-2 list-inside list-disc">
            <li>Statistiques</li>
            <li>Contact</li>
          ...
          <p>
            ...
            refuser que leurs renseignements personnels soient utilis&eacute;es &agrave; certaines fins
            mentionn&eacute;es lors de la collecte.
            <br />
          </p>
          <p>
            Le droit de retrait s&apos;entend comme &eacute;tant la possiblit&eacute; offerte aux internautes de
            demander &agrave; ce que leurs renseignements personnels ne figurent plus, par exemple, dans une liste de
            diffusion.
            <br />
          </p>
          <p>
          ...
          <p>
            Nous nous engageons &agrave; reconna&icirc;tre un droit d&apos;acc&egrave;s et de rectification aux
            personnes concern&eacute;es d&eacute;sireuses de consulter, modifier, voire radier les informations les
            concernant.
            <br />
          ...
          <p>
            ...
            s&eacute;curis&eacute;. Les personnes travaillant pour nous sont tenues de respecter la
          ...
          <p>
            Nous nous engageons &agrave; maintenir un haut degr&eacute; de confidentialit&eacute; en int&eacute;grant
            les derni&egrave;res innovations technologiques permettant d&apos;assurer la confidentialit&eacute; de vos
...
export default withBlitz(Privacy);
