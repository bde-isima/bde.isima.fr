...
export default function Manager({ open, event, onClose }) {
    ...
    const eventSubscriptionsQueryResult = useQuery(getEventSubscriptions, {
            ...
            >
                ...
                <DialogContent>
                    <TabContext value={value.toString()}>
                        <TabPanel value="0">
                            <SubscriptionsAnalytics eventSubscriptionsQueryResult={eventSubscriptionsQueryResult} />
                        </TabPanel>

                        <TabPanel value="1">
                            <SubscriptionsList event={event} eventSubscriptionsQueryResult={eventSubscriptionsQueryResult} />
                        </TabPanel>
